      ...
      //  private static readonly string DbPath = Path.Combine(@"C:\temp\", DbName);
        ...
        private static void FillDb()
        {
            using (var db = DbConnection)
            {
                ...
                {
                    new SensorType {Type = "DS18B20", Descript = "Temperatura"},
                    new SensorType {Type = "DHT11", Descript = "Temperatura i wilgotność"},
                    new SensorType {Type = "DHT22", Descript = "Temperatura i wilgotność"},
                    new SensorType {Type = "BMP180", Descript = "Temperatura i ciśnienie"},
                    new SensorType {Type = "ACS712", Descript = "Czujnik przepływu prądu"},
                    new SensorType {Type = "OnOff", Descript = "Czujnik On / Off"}
                };
                ...
                List<Sensors> sensors = new List<Sensors>
                {
                    new Sensors
                    {
                        ...
                        Descript = "Temperatura na zewnątrz",
                        Pin = null
                    },
                    new Sensors
                    {
                        ...
                        Descript = "Wilgotność na zewnątrz",
                        Pin = null
                    },
                    new Sensors
                    {
                        ...
                        DataBusTypeId = 6,
                        SensorType = "BMP180",
                        Name = "Ciśnienie na zewnątrz",
                        Descript = "Ciśnienie na zewnątrz",
                        Pin = null
                    },
                    new Sensors
                    {
                    ...
                    new Sensors
                    {
                        ...
                        SensorType = "DS18B20",
                        Name = "CO",
                        Descript = "Temperatura na piecu",
                        Address = "287C35280000804D"
                    },
                    new Sensors
                    {
                        Id = 8,
                        ...
                        SensorType = "DS18B20",
                        Name = "Spaliny",
                        Descript = "Temperatura spalin",
                        Address = "280B2328000080B0"
                    },
                    new Sensors
                    {
                        Id = 9,
                        DataBusTypeId = 2,
                        SensorType = "DS18B20",
                        Name = "Sypialnia balkon",
                        Descript = "Sypialnia balkon",
                        Address = "28FF1BFB54160463"
                    },
                    new Sensors
                    {
                        Id = 10,
                        ...
                        SensorType = "DS18B20",
                        Name = "Sypialnia TV",
                        Descript = "Sypialnia TV",
                        Address = "28FF18FF54160423"
                    },
                    new Sensors
                    {
                        Id = 11,
        ...
        private static async Task<bool> CheckDbAsync()
        {
            ...
            try
            {
                StorageFile sf = await ApplicationData.Current.LocalCacheFolder.GetFileAsync(DbName);
            }
            catch (Exception)
            {
